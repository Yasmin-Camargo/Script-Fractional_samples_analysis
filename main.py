...
def vetores_fracionarios(pasta_arquivos, nome_arquivo): 
    ...
    for linha in arquivo:
        if ("Sequence size" in linha and passou_resolucao == 0):  # linha com a resolução 
            passou_resolucao = 1
            CTU_Line_Total = math.ceil(int(linha.split(" ")[4].replace("]","")) / 128) 
            
            # cria váriavel para armazenar lines
            temp_LD_Line = []
        ...
        if (linha_certa == 1): 
            if (frame != linha[1] and flag_frame == 1): # se mudou de frame, armazena dados no csv
                for i in range (0, CTU_Line_Total):
                    tabela.write(f'{temp_LD_Line[i]}')
                tabela.write(f'{nome_arquivo[0]}; {nome_arquivo[2].split(".")[0]}; {nome_arquivo[1]}; ')
                tabela.write(f'{frame}; L0; {(cont_line_CTU)} --> y[{(cont_line_CTU)*128}, {((cont_line_CTU+1)*128)}]; {mvL0["I"]}; {mvL0["H0"]}; {mvL0["H1"]}; {mvL0["H2"]}; {mvL0["Q0"]}; {mvL0["Q1"]}; {mvL0["Q2"]}; {mvL0["Q3"]}; {mvL0["Q4"]}; {mvL0["Q5"]}; {mvL0["Q6"]}; {mvL0["Q7"]}; {mvL0["Q8"]}; {mvL0["Q9"]}; {mvL0["Q10"]}; {mvL0["Q11"]}\n')
                           
                for i in range (0, CTU_Line_Total):
                    tabela.write(f'{temp_RA_Line[i]}') 
                tabela.write(f'{nome_arquivo[0]}; {nome_arquivo[2].split(".")[0]}; {nome_arquivo[1]}; ')
                tabela.write(f'{frame}; L1; {(cont_line_CTU)} --> y[{(cont_line_CTU)*128}, {((cont_line_CTU+1)*128)}]; {mvL1["I"]}; {mvL1["H0"]}; {mvL1["H1"]}; {mvL1["H2"]}; {mvL1["Q0"]}; {mvL1["Q1"]}; {mvL1["Q2"]}; {mvL1["Q3"]}; {mvL1["Q4"]}; {mvL1["Q5"]}; {mvL1["Q6"]}; {mvL1["Q7"]}; {mvL1["Q8"]}; {mvL1["Q9"]}; {mvL1["Q10"]}; {mvL1["Q11"]}\n')
            ...
            if (flag_linha == 1 and int(linha[3]) > ((cont_line_CTU + 1) * 128)): # mudou de linha CTU
            ...
            if(linha[6] == 'MVL0' or linha[6] == 'MVL1'): 
                flag_linha = 1 
                flag_frame = 1                                      # converte para binário:
...
tabela.write("Video; QP; Config; Frame POC; Ref. frame list; CTU Line; I; H0; H1; H2; Q0; Q1; Q2; Q3; Q4; Q5; Q6; Q7; Q8; Q9; Q10; Q11\n")
tabela.close()
...
def vetores_fracionarios(pasta_arquivos, nome_arquivo): 
    ...
    for linha in arquivo:
        ...
        if (linha_certa == 1): 
            if (frame != linha[1] and flag == 1): # se mudou de frame, armazena dados no csv
                tabela.write(f'{nome_arquivo[0]}; {nome_arquivo[2].split(".")[0]}; {nome_arquivo[1]}; ')
                tabela.write(f'{frame}; L0; {mvL0["I"]}; {mvL0["H0"]}; {mvL0["H1"]}; {mvL0["H2"]}; {mvL0["Q0"]}; {mvL0["Q1"]}; {mvL0["Q2"]}; {mvL0["Q3"]}; {mvL0["Q4"]}; {mvL0["Q5"]}; {mvL0["Q6"]}; {mvL0["Q7"]}; {mvL0["Q8"]}; {mvL0["Q9"]}; {mvL0["Q10"]}; {mvL0["Q11"]}\n')
                tabela.write(f'{nome_arquivo[0]}; {nome_arquivo[2].split(".")[0]}; {nome_arquivo[1]}; ')
                tabela.write(f'{frame}; L1; {mvL1["I"]}; {mvL1["H0"]}; {mvL1["H1"]}; {mvL1["H2"]}; {mvL1["Q0"]}; {mvL1["Q1"]}; {mvL1["Q2"]}; {mvL1["Q3"]}; {mvL1["Q4"]}; {mvL1["Q5"]}; {mvL1["Q6"]}; {mvL1["Q7"]}; {mvL1["Q8"]}; {mvL1["Q9"]}; {mvL1["Q10"]}; {mvL1["Q11"]}\n')
...
for nome_arquivo in todos_arquivos:
    if (nome_arquivo.split(".")[1] == "csv"):
>>>>>>> 1617f3cb31ff6b8cd2cfbff7f0b311d0087e5298
